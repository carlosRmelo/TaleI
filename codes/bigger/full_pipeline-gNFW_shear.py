...
def run(data_path, ncores):
    ...
    imaging = al.Imaging.from_fits(
        image_path=path.join("./{}/".format(data_path), "image_cut.fits"),
        noise_map_path=path.join("./{}/".format(data_path), "noise_scaled_cut.fits"),
    ...
    output_path = data_path.split("/")[1]+"/model_shear"
