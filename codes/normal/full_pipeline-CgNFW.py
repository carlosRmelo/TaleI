...
def run(data_path):
    ...
    CM.include_DM_MGE(profile="CgNFW")              #Setting Dark matter component
    CM.include_BH()                                 #Include a central BH
    ...
    parsDic = {
                ...
                "log_M0":  p.UniformPrior(5, 13),
                "rc":      p.UniformPrior(0, 15),
