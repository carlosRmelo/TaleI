...
Here we derive the slope from the model, using the Fiducial mass profile.
"""
...
def run(result_path):
    ...
    rho_dm = dm_density["distribution"]
    r_dm   = dm_density["radii"]

    # Load star density profile
    rho_star = stellar_density["distribution"]
    r_star   = stellar_density["radii"]
